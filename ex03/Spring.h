...
class Spring {
	public:
		 ...
		 */
		Spring(Particle &p1, Particle &p2, Stiffness stiffness, SpringDamping damping, Length length):
		 ...
		 */
		Spring(Particle &p1, Particle &p2, Stiffness stiffness, SpringDamping damping, double length=1.0):
